      ...
      >
        ...
        <div className="bg-navy-900 dark:bg-gray-800 rounded-t-2xl p-8 print:rounded-none print:p-6">
          ...
          <div className="flex flex-wrap gap-6 mt-6 text-sm print:gap-4 print:text-xs">
            ...
            <a href="https://jamie-arlin-portfolio-npilnrnspa-uc.a.run.app" target="_blank" rel="noopener noreferrer" className="text-primary-400 hover:text-primary-300 flex items-center gap-2">
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
